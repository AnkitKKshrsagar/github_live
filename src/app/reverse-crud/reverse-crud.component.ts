...
@Component({
  selector: 'app-reverse-crud',
  templateUrl: './reverse-crud.component.html',
  styleUrls: ['./reverse-crud.component.scss']
})
export class ReverseCrudComponent {
  name: any;
  email: any;
  msg: any;
  data: any = [];
  ...
  sub() {
    ...
    this.data[this.selectedIndex].email = this.email.reverse(obj);
    this.data[this.selectedIndex].name = this.name.reverse(obj);
    this.data[this.selectedIndex].msg = this.msg.reverse(obj);
